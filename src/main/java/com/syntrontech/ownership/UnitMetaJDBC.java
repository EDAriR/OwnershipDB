...
//        updateby
    ...
    public void getUnitMetaById() throws SQLException {
        ...
        try {
            ...
            if (rs != null) {
                while (rs.next()) {
                	...
                	String ownership_type = rs.getString("ownership_type");
                	String ownership_status = rs.getString("ownership_status");
                	String model_status = rs.getString("model_status");
